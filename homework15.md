...
```
nonstop@umbrella:~/terraform308$ terraform workspace new stage
Created and switched to workspace "stage"!

You're now on a new, empty workspace. Workspaces isolate their state,
so if you run "terraform plan" Terraform will not see any existing state
for this configuration.
nonstop@umbrella:~/terraform308$ terraform workspace new prod
...
```
```
nonstop@umbrella:~/terraform308$ terraform workspace list
  default
* prod
  stage
``` 
```
nonstop@umbrella:~/terraform308$ terraform workspace select prod
```
```
nonstop@umbrella:~/terraform308$ terraform plan
